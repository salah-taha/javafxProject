...
public class FadeTransition {
    ...
    public static void fadeInFadeOut(Node node, Duration duration, EventHandler<ActionEvent> event){
    ...
    public static void fadeOut(Node node,Duration duration,EventHandler<ActionEvent> event){
        javafx.animation.FadeTransition fadeOut = new javafx.animation.FadeTransition(duration,node);
        fadeOut.setCycleCount(1);
        fadeOut.setFromValue(1);
        fadeOut.setToValue(0.4);
